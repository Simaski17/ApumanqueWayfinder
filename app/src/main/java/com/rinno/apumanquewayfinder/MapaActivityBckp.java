...
public class MapaActivityBckp extends AppCompatActivity {
...
//                    Graph.Vertex<String> a = new Graph.Vertex<String>(edg.getInicio());
//                    Graph.Vertex<String> b = new Graph.Vertex<String>(edg.getFin());
//
...
//                cambiarFondoPiso();
//                stairEvent();
//                //Log.e("TAG", "ContadorPISO: " + contadorPiso);
////                Log.e("TAG","WWWWWWWWWWWW "+arregloIdRuta);
//
//
//                break;
...
//        if (contadorPiso == 1) {
//            rlPisos.setBackgroundDrawable(getResources().getDrawable(R.drawable.pisouno));
//        } else if (contadorPiso == 2) {
//            rlPisos.setBackgroundDrawable(getResources().getDrawable(R.drawable.pisodos));
//        } else {
//            rlPisos.setBackgroundDrawable(getResources().getDrawable(R.drawable.pisotres));
//        }
//    }
//
